...
//    import _ "github.com/conku/gorm/dialects/mysql"
//    // import _ "github.com/conku/gorm/dialects/postgres"
//    // import _ "github.com/conku/gorm/dialects/sqlite"
//    // import _ "github.com/conku/gorm/dialects/mssql"
...
func (s *DB) SetNowFuncOverride(nowFuncOverride func() int64) *DB {
...
func (s *DB) slog(sql string, t int64, vars ...interface{}) {
	if s.logMode == detailedLogMode {
		//rowei 2021
		s.print("sql", fileWithLineNum(), time.Unix(NowFunc(), 0).Sub(time.Unix(t, 0)), sql, vars, s.RowsAffected)
	}
}
