...
func TestRelated(t *testing.T) {
	user := User{
		...
		Emails:          []Email{{Email: "conku@example.com"}, {Email: "conku-2@example@example.com"}},
	...
	var emails2 []Email
	DB.Model(&user).Where("email = ?", "conku@example.com").Related(&emails2)
	if len(emails2) != 1 {
		t.Errorf("Should have two emails")
	}
...
func TestAutoSaveBelongsToAssociation(t *testing.T) {
	...
	DB.Save(&User{Name: "conku", Company: Company{Name: "auto_save_association"}})
	...
	user := User{Name: "conku", Company: company}
	...
	user2 := User{Name: "conku_2", Company: Company{Name: "auto_save_association_2"}}
...
func TestAutoSaveHasOneAssociation(t *testing.T) {
	...
	DB.Save(&User{Name: "conku", Company: Company{Name: "auto_save_has_one_association"}})
	...
	user2 := User{Name: "conku_2", Company: Company{Name: "auto_save_has_one_association_2"}}
	DB.Set("gorm:association_autocreate", true).Save(&user2)
...
func TestAutoSaveMany2ManyAssociation(t *testing.T) {
	...
	DB.Save(&User{Name: "conku", Companies: []Company{{Name: "auto_save_m2m_association"}}})
	...
	user := User{Name: "conku", Companies: []Company{company, {Name: "auto_save_m2m_association_new_name_2"}}}
